...
@time: 2018/10/23 13:50
"""
from sqlalchemy import Column, String, Numeric, Date, Time, Integer,Text,BOOLEAN,MetaData,CHAR
from shannon_spider.db import  ItemBaseModel, CommonFieldMixin


class ChinamoneyBondNewItem(CommonFieldMixin, ItemBaseModel):
    ''' 货币网的抓取结果'''
    __tablename__ = 'chinamoney_bond_new'
    desc = '企业债信息'
    ...
    UPGRADE_TIME = Column(String(20),doc={"zh":"更新时间"})