...
class ApprovalOfBloodProductSCVaccineItem(CommonFieldMixin, ItemBaseModel):
    """血制品疫苗批签发数据库四川省"""

    __tablename__ = 'approval_of_blood_product_vaccine_sichuan'
    ...
    # 签发日期
    ISSUE_DATE = Column(String(20), doc={'zh', '签发日期'})
