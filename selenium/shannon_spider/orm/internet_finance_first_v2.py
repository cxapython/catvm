...
class InternetFinanceFirstV2Item(CommonFieldMixin, ItemBaseModel):
    """
    互联网金融协会运营信息一
    """
    __tablename__ = 'internet_finance_first_v2'
    desc = '互联网金融协会数据'
    ...
    TOTAL_CREDIT_MONEY = Column(VARCHAR(20), doc={'zh', '累计借贷金额（万元）'})  # 新加字段
