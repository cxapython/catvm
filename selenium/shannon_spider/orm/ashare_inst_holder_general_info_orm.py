...
class AshareInstHolderGeneralInfoItem(CommonFieldMixin, ItemBaseModel):
    __tablename__ = 'ashare_inst_holder_general_info'
    ...
    s_holder_number = Column(VARCHAR(50), doc={'zh': '持股家数'})
